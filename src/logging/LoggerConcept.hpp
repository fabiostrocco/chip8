...
namespace logging
{
    ...
    concept LoggerConcept = std::is_arithmetic<LogArgument>::value || logging::is_string<LogArgument>::value ||
        is_char_ptr<LogArgument>::value || is_const_char_ptr<LogArgument>::value;
}